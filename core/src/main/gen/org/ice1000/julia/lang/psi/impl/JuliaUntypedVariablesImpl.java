...
public class JuliaUntypedVariablesImpl extends ASTWrapperPsiElement implements JuliaUntypedVariables {

  public JuliaUntypedVariablesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitUntypedVariables(this);
  }
