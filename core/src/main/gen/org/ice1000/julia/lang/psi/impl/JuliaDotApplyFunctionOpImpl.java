...
public class JuliaDotApplyFunctionOpImpl extends JuliaExprImpl implements JuliaDotApplyFunctionOp {

  public JuliaDotApplyFunctionOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitDotApplyFunctionOp(this);
  }
