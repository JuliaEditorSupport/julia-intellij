...
public class JuliaBracketedComprehensionExprImpl extends JuliaExprImpl implements JuliaBracketedComprehensionExpr {

  public JuliaBracketedComprehensionExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitBracketedComprehensionExpr(this);
  }
