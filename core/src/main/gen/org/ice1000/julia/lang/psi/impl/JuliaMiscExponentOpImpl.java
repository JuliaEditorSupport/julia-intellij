...
public class JuliaMiscExponentOpImpl extends JuliaExprImpl implements JuliaMiscExponentOp {

  public JuliaMiscExponentOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitMiscExponentOp(this);
  }
