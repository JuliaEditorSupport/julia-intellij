...
public class JuliaUnaryTypeOpImpl extends JuliaExprImpl implements JuliaUnaryTypeOp {

  public JuliaUnaryTypeOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitUnaryTypeOp(this);
  }
