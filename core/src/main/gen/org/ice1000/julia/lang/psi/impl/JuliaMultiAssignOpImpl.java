...
public class JuliaMultiAssignOpImpl extends JuliaExprImpl implements JuliaMultiAssignOp {

  public JuliaMultiAssignOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitMultiAssignOp(this);
  }
