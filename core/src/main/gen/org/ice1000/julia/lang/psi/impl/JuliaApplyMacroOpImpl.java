...
public class JuliaApplyMacroOpImpl extends JuliaExprImpl implements JuliaApplyMacroOp {

  public JuliaApplyMacroOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitApplyMacroOp(this);
  }
