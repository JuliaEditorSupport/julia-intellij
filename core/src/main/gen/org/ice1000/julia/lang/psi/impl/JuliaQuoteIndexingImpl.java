...
public class JuliaQuoteIndexingImpl extends JuliaExprOrEndImpl implements JuliaQuoteIndexing {

  public JuliaQuoteIndexingImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitQuoteIndexing(this);
  }
