...
public class JuliaStringLikeMultiplyOpImpl extends JuliaExprImpl implements JuliaStringLikeMultiplyOp {

  public JuliaStringLikeMultiplyOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitStringLikeMultiplyOp(this);
  }
  ...
  @Override
  @NotNull
  public List<JuliaString> getStringList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JuliaString.class);
  }
