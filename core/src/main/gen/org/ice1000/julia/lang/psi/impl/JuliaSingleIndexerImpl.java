...
public class JuliaSingleIndexerImpl extends ASTWrapperPsiElement implements JuliaSingleIndexer {

  public JuliaSingleIndexerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitSingleIndexer(this);
  }
