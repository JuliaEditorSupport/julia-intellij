...
public class JuliaApplyFunctionOpImpl extends JuliaExprImpl implements JuliaApplyFunctionOp {
  ...
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitApplyFunctionOp(this);
  }
  ...
  @Override
  @NotNull
  public List<JuliaArguments> getArgumentsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JuliaArguments.class);
  }
