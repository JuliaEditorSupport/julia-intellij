...
public class JuliaUnarySubtypeOpImpl extends JuliaExprImpl implements JuliaUnarySubtypeOp {

  public JuliaUnarySubtypeOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitUnarySubtypeOp(this);
  }
