...
public class JuliaPlusLevelOpImpl extends JuliaExprImpl implements JuliaPlusLevelOp {

  public JuliaPlusLevelOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitPlusLevelOp(this);
  }
