...
public class JuliaMemberAccessOpImpl extends JuliaExprImpl implements JuliaMemberAccessOp {

  public JuliaMemberAccessOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitMemberAccessOp(this);
  }
