...
public class JuliaPipeLevelOpImpl extends JuliaExprImpl implements JuliaPipeLevelOp {

  public JuliaPipeLevelOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitPipeLevelOp(this);
  }
  ...
  @Override
  @NotNull
  public JuliaPipeLevelOperator getPipeLevelOperator() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, JuliaPipeLevelOperator.class));
  }
