...
public class JuliaImplicitMultiplyOpImpl extends JuliaExprImpl implements JuliaImplicitMultiplyOp {

  public JuliaImplicitMultiplyOpImpl(ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitImplicitMultiplyOp(this);
  }
