...
public class JuliaBracketedExprIndexingImpl extends JuliaExprOrEndImpl implements JuliaBracketedExprIndexing {

  public JuliaBracketedExprIndexingImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public <R> R accept(@NotNull JuliaVisitor<R> visitor) {
    return visitor.visitBracketedExprIndexing(this);
  }
