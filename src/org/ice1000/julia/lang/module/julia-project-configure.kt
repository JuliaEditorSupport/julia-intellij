...
//	}
	...
	private val downloadJuliaSdkLink = Link(JULIA_WEBSITE, action = {
	...
	private val versionToLabel = JLabel(versionOf(sdkHomePath))

	private fun pathToDirectoryTextField(disposable: Disposable,
																			 title: String,
