...
CHAR_ESCAPE=(\\[\'\"bnrt])|{CHAR_ESCAPE_UNICODE}
CHAR_UNICODE=(\\u[a-fA-F0-9]{4})|({CHAR_ESCAPE_UNICODE}{3})
CHAR_ESCAPE_UNICODE=\\x[a-fA-F0-9]{2}
CHAR_LITERAL={INCOMPLETE_CHAR}'

LINE_COMMENT=#[^\n=]?[^\n]*
BLOCK_COMMENT={BLOCK_COMMENT_BEGIN}{BLOCK_COMMENT_CONTENT}{BLOCK_COMMENT_END}
BLOCK_COMMENT_BEGIN=#=
BLOCK_COMMENT_END==#
